...
********************************/
DROP TABLE IF EXISTS TEMP_LU_CONDITIONS;
...
DROP TABLE IF EXISTS TEMP_LU_CONDITION_CHILDREN;
...
DROP TABLE IF EXISTS TEMP_DRUG_HOI_EVIDENCE_INGREDIENT;
...
DROP TABLE IF EXISTS TEMP_LAERTES_DRUG_UNIVERSE;
...
CTE_TEST_EVIDENCE AS (
	...
	FROM CTE_TOTAL_CONDITIONS c
		LEFT OUTER JOIN LU_CONDITIONS_CHILDREN cc
...
-- ALTER TABLE PENELOPE_LAERTES_UNIVERSE
--   OWNER TO rich;
