...
/*-----------------------------*/
\echo 'Find Conditions & Modality'

SELECT DISTINCT HOI AS CONDITION_CONCEPT_ID, SNOMED_HOI AS CONDITION_CONCEPT_NAME, EVIDENCE_TYPE, MODALITY 
INTO TEMP TABLE TEMP_CONDITIONS_MODALITY
