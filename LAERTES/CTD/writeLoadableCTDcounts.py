...
EVTYPE = "SPL_CTD"
DATAFILE = "test-query-of-counts.csv" # NOTE: this data comes a CSV export of the following query / ??? / Create test query like the query on Line 19 against our own graph
...
# FROM <http://purl.org/net/nlprepository/ohdsi-adr-ctd-poc>
# WHERE {
